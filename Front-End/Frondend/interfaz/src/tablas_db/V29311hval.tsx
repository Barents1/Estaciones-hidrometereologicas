...
interface IState {
    ...
    v29311hvals:any[],
    modalTitle:string,
    id_temp_aire_max_val: number,
    id_temp_aire_max: number,
    id_estacion: number,
    ...
    v29311hvalsFilter:any[],
    id_temp_aire_max_valFilter: number,
    id_temp_aire_maxFilter: number,
...
export class V29311hval extends Component<IProps,IState> {
    ...
    constructor(props: IProps){
        ...
        this.state={
            ...
            v29311hvalsFilter:[''],
            id_temp_aire_max_valFilter: 0,
            id_temp_aire_maxFilter: 0,
            id_estacionFilter: 0,
    ...
    FilterFn(){
        ...
        var  id_temp_aire_max_valFilter=this.state.id_temp_aire_max_valFilter;
        var  id_temp_aire_maxFilter=this.state.id_temp_aire_maxFilter;
        ...
        var filteredData=this.state.v29311hvalsFilter.filter(
            function(el){
                return el.id_temp_aire_max_valFilter.toString().toLowerCase().includes(
                    id_temp_aire_max_valFilter.toString().trim().toLowerCase()
                )&&
                el.id_temp_aire_maxFilter.toString().toLowerCase().includes(
                    id_temp_aire_maxFilter.toString().trim().toLowerCase()
                )&&
        ...
        this.setState({v29311hvals:filteredData});

    }

    sortResult(prop:any,asc:any){
        var sortedData=this.state.v29311hvalsFilter.sort(function(a,b){
            if(asc){
        ...
        this.setState({v29311hvals:sortedData});
    }
 
    changeid_temp_aire_max_valFilter = (e:any)=>{
        this.state.id_temp_aire_max_valFilter.valueOf=e.target.value;
        this.FilterFn();
    }
    changeid_temp_aire_maxFilter = (e:any)=>{
        this.state.id_temp_aire_maxFilter.valueOf=e.target.value;
        this.FilterFn();
    }
    ...
    changeid_temp_aire_max =(e:any)=>{
        this.setState({id_temp_aire_max:e.target.value});
    }
    ...
    refreshList(){
        ...
        fetch(variables.API_URL+'v29311hval')
        .then(response=>response.json())
        .then(data=>{
            this.setState({v29311hvals:data});
        });
    }
    componentDidMount(){
        this.refreshList();
    ...
    editClick(v10:any){
        this.setState({
            ...
            id_temp_aire_max_val:v10.id_temp_aire_max_val,
            id_temp_aire_max:v10.id_temp_aire_max,
    ...
    createClick(){
        ...
        fetch(variables.API_URL+'v29311hval',{
            ...
            body:JSON.stringify({
                id_temp_aire_max:this.state.id_temp_aire_max,
    ...
    updateClick(){
        fetch(variables.API_URL+'v29311hval',{
            ...
            body:JSON.stringify({
                id_temp_aire_max_val:this.state.id_temp_aire_max_val,
                id_temp_aire_max:this.state.id_temp_aire_max,
                id_estacion:this.state.id_estacion,
                id_unidad_medida:this.state.id_unidad_medida,
                id_usuario:this.state.id_usuario,
    ...
    deleteClick(id:number){
        ...
        fetch(variables.API_URL+'v29311hval/'+id,{
            method:'DELETE',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
        ...
        return(
            ...
            onClick={()=>this.addClick()}>
              ...
              <table className="table table-striped">
                  ...
                  <tbody>
                     {v29311hvals.map(v10=>
                        <><tr key={v10.id_temp_aire_max_val}></tr>
                        <td>{v10.id_temp_aire_max_val}</td>
                        <td>{v10.id_temp_aire_max}</td>
                ...
                <button type="button"
                className="btn btn-light mr-1"
              onClick={()=>this.deleteClick(v10.id_temp_aire_max_val)}>
...
<div className="modal-content">
   <div className="modal-header">   
       ...
       <div className="input-group mb-3">
        <span className="input-group-text">id_temp_aire_max </span>
        <input type="number" className="form-control"
        value={id_temp_aire_max}
        onChange={this.changeid_temp_aire_max}/>
       </div>
       <div className="input-group mb-3">
