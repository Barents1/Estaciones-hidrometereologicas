...
export class V29311h extends Component<IProps,IState> {
    ...
    FilterFn(){
        ...
        var filteredData=this.state.v29311hFilter.filter(
            function(el){
                return el.id_temp_aire_maxFilter.toString().toLowerCase().includes(
        ...
        this.setState({v29311h:filteredData});

    }

    sortResult(prop:any,asc:any){
        var sortedData=this.state.v29311hFilter.sort(function(a,b){
            if(asc){
        ...
        this.setState({v29311h:sortedData});
    }
    ...
    refreshList(){
        ...
        fetch(variables.API_URL+'v29311h')
        .then(response=>response.json())
        .then(data=>{
            this.setState({v29311h:data});
        });
    }
    componentDidMount(){
        this.refreshList();
    ...
    deleteClick(id:number){
        ...
        fetch(variables.API_URL+'v29311h/'+id,{
            method:'DELETE',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
        ...
        return(
            ...
            onClick={()=>this.addClick()}>
              ...
              <table className="table table-striped">
                  ...
                  <tbody>
                     {v29311h.map(v10=>
                        <><tr key={v10.id_temp_aire_max}></tr>
                ...
                <button type="button"
                className="btn btn-light mr-1"
              onClick={()=>this.deleteClick(v10.id_temp_aire_max)}>
